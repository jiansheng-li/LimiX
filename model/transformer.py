...
class FeaturesTransformer(nn.Module):
    ...
    def forward(self, x: torch.Tensor,
                ...
                **kwargs) -> torch.Tensor | dict[str, torch.Tensor] | tuple[
        ...
        '''
            ...
            task_type: Type of task, options: cls(classification), reg(regression), emb(embedding)
            calculate_sample_attention: Whether to calculate sample attention
            calculate_feature_attention: Whether to calculate feature attention
            return_all_information: Whether to return all information
